...
[x, Fs]=audioread('../audio/packetlossrecovery/missing/armst_37_missing.wav');
xt=x(:,1)';
error_var=9.4588e-08;

% % Missing file 2 (AR 6)
% [x, Fs]=audioread('../audio/packetlossrecovery/missing/grosse_40_percent_missing.wav');
% xt=x(:,1)';
% error_var=3.7607e-07;

%%%%Change this P value to the AR model%%%%
P=20;
